...
let myDecipher = decipher('uges@x-pertiz@2020')

uges_forumid = myDecipher(localStorage.getItem("uges_forumid"));

$(document).ready(function() {

    //alert(localStorage.getItem("username"));
    if (typeof(localStorage.getItem("uges_mode_connect")) != undefined && typeof(localStorage.getItem("uges_username")) != undefined && typeof(localStorage.getItem("uges_avatar")) != undefined && typeof(localStorage.getItem("uges_forumid")) != undefined) {

        let mode_connect = myDecipher(localStorage.getItem("uges_mode_connect"));
        let matiere = myDecipher(localStorage.getItem("uges_matiere"));
        let uges_forumid = myDecipher(localStorage.getItem("uges_forumid"));

        //$('#Public').setAttribute("data-tipe", matiere);
        document.getElementById("Public").setAttribute("data-tipe", 'rooms');

        if (mode_connect == 'uges_offline') {
            localStorage.setItem("uges_mode_connect", "connectez");
            loginFunction();
        }
...
ajax("POST", "data=cek", res => {
            ...
            var matiere = myDecipher(localStorage.getItem("uges_matiere"));
        ...
        userRef.push(h);
        userlogin = a.user;
        document.getElementById("heading-name-meta").innerHTML = matiere;
...
function loginFunction() {
    ...
    //let matiere= myDecipher(localStorage.getItem("uges_matiere"))  ;
    const avatar= myDecipher(localStorage.getItem("uges_avatar"))  ;
    const i= myDecipher(localStorage.getItem("uges_username"))  ;
    ...
    if (i != '' && avatar != '') {
        ajax("POST", `data=login&name=${i}&avatar=${avatar}`, res => {
            ...
            if (a.status == 'success') {
                ...
                document.getElementById("ref").innerHTML = "<div class='alert alert-danger'>Nom d'utilisateur incorrect !!</div>";
            }
        });
    } else {
        alert('Erreur connectez vous!!')
...
var chat_realtime = (j, k, l, m, n, imageDir, domain) => {
    ...
    let no = 0;
    const limit = 10;
    let uKe= myDecipher(localStorage.getItem("uges_forumid"))  ;

    //let uKe= myDecipher(localStorage.getItem("uges_matiere"))  ;
