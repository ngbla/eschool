$(document).ready(function() {
    ...
    $('#dataTable_list_notesElev tfoot th').each(function() {
        var title = $(this).text();
    ...
    $('#dataTableensembledescours').DataTable({
        dom: 'Blfrtip',
        buttons: [
            /*{
                extend:    'copyHtml5',
    ...
    $('#dataTablecoursresents').DataTable({
        dom: 'Blfrtip',
        buttons: [
            /*{
                extend:    'copyHtml5',
    ...
    $('#dataTablecoursavenir').DataTable({
        dom: 'Blfrtip',
        buttons: [
            /*{
                extend:    'copyHtml5',
    ...
    $('#dataTable_list_notesElev').DataTable({
    ...
    $('#dataTable_list_elevmoy').DataTable({
        dom: 'Blfrtip',
        "lengthMenu": [
            [10, 25, 50, -1],
            [10, 25, 50, "All"]
    ...
    function ajaxPost(url , values){
        var etat = 0 ;
            ...
            .done(function(data) {
                ...
                etat = 1;
                //console.log("this.etatinfo ="+this.etatinfo);
            })
            .fail( function() {  
                etat = 0;  
                //console.log("this.etatinfo ="+this.etatinfo);
